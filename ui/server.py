...
BRIDGE_VERSION = "4.76"       # версия моста; /x/health отдаёт её, single-instance по ней решает «свежий/старый»
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if self.path == "/x/expert":
            ...
            _out = str(RUNS_DIR / ("preview_" + _ns(sid) + ".pdf"))
            res = run_expert("fmt_report_pdf",
