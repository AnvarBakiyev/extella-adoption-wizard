...
BRIDGE_VERSION = "4.09"       # версия моста; /x/health отдаёт её, single-instance по ней решает «свежий/старый»
...
def _gen_source_code(spec):
    ...
    prompt = (
        ...
        "- Ключи/токены/базу бери ТОЛЬКО из аргумента secret (например secret['token']). НЕ хардкодь секреты.\n"
